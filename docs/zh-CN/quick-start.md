...
- [中文 Demo](examples/demo)
- [中文 MCP 指南](integrations/mcp)
- [中文 Runbook](guides/RUNBOOK)
- [中文 View Layer 指南](guides/VIEW-LAYER)
- [中文 Prompt Engine 设计](design/PROMPT-ENGINE)
- [中文架构总览](design/ARCHITECTURE-OVERVIEW)
- [中文任务执行模型](design/TASK-EXECUTION-MODEL)
- [中文 LLM 基准](specs/LLM-BENCHMARKS)
- [中文规范导航](specs/)

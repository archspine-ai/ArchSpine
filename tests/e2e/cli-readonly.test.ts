...
describe('E2E: Read-only commands', () => {
  ...
  describe('spine info (status / languages / usage)', () => {
    it('INFO-02: reports sync status after init', () => {
      const dir = makeTempDir();
      createdDirs.push(dir);
      initGitRepo(dir);

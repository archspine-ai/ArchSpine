...
import type { PromptTaskMode } from '../../prompt-policy.js';
...
export class MockClient implements LLMClient {
  ...
  /**
   * Simulates LLM-based violation detection for use in tests and demos.
   * Only detects infra-layer-isolation pattern violations — real LLM providers
   * evaluate all rule types against the full file content.
   */
...
`;
  ...
  async generateSummary(
    ...
    markdownRecord.English = `# File: ${filePath}\n\n## Role\nMock Summary for ${filePath}\n\n## Responsibility\n- Mock description of ${filePath}`;
  ...
  async generateFolderSummary(
    ...
    const markdownRecord: Record<string, string> = {};
    markdownRecord.English = `# Directory: ${dirPath}\n\n## Role\nMock Folder Summary for ${dirPath}\n\n## Responsibility\nMock responsibilities for ${dirPath}`;
  ...
  async generateProjectSummary(
    ...
    const markdownRecord: Record<string, string> = {};
    markdownRecord.English = `# Project: ${projectName}\n\n## Role\nMock Project Summary for ${projectName}\n\n## Responsibility\nMock responsibilities for project ${projectName}`;

...
function renderPublicSurfaceGroup(title: string, items: IPublicSurfaceViewItem[]): string {
  if (items.length === 0) {
...
function renderRiskRows(items: IRiskHotspotViewItem[]): string {
  if (items.length === 0) {
...
function renderRiskDetails(items: IRiskHotspotViewItem[]): string {
  if (items.length === 0) {
...
export class ViewRenderer {
  public static renderRiskHotspots(data: IViewArtifactEnvelope<IRiskHotspotViewItem>): string {
  ...
  public static renderPublicSurface(data: IViewArtifactEnvelope<IPublicSurfaceViewItem>): string {

...
const LANG_EXTENSION_MAP: Record<string, InternalLangConfig> = {
  ...
  '.swift': {
    ...
    loader: createLoader('@ast-grep/lang-swift'),
    packageName: '@ast-grep/lang-swift',
  },
  '.php': {
    ruleName: 'php',
    langKey: 'php',
    sourceLanguage: 'php',
    loader: createLoader('@ast-grep/lang-php'),
    packageName: '@ast-grep/lang-php',
  },
  '.rb': {
    ruleName: 'ruby',
    langKey: 'ruby',
    sourceLanguage: 'ruby',
    loader: createLoader('@ast-grep/lang-ruby'),
    packageName: '@ast-grep/lang-ruby',
  },
  '.kt': {
    ruleName: 'kotlin',
    langKey: 'kotlin',
    sourceLanguage: 'kotlin',
    loader: createLoader('@ast-grep/lang-kotlin'),
    packageName: '@ast-grep/lang-kotlin',
  },
  '.kts': {
    ruleName: 'kotlin',
    langKey: 'kotlin',
  ...
  '.scala': {
    ...
    loader: createLoader('@ast-grep/lang-scala'),
    packageName: '@ast-grep/lang-scala',
  },
  '.sc': {
    ruleName: 'scala',
    langKey: 'scala',
  ...
  '.ex': {
    ...
    loader: createLoader('@ast-grep/lang-elixir'),
    packageName: '@ast-grep/lang-elixir',
  },
  '.exs': {
    ruleName: 'elixir',
    langKey: 'elixir',
